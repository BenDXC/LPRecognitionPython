...
import GreyscaleLocal

# this gets all the connected regions and groups them together
label_image = measure.label(GreyscaleLocal.binary_car_image)
...
ax1.imshow(GreyscaleLocal.gray_car_image, cmap="gray")
...
for region in regionprops(label_image):
    ...
    if (
        ...
        plate_like_objects.append(
            GreyscaleLocal.binary_car_image[min_row:max_row, min_col:max_col]
        )
